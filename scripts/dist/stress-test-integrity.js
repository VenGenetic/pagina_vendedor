...
async function runScenario1_DoubleTap() {
    ...
    if (successes.length === 1 && failures.length === 4 && (product === null || product === void 0 ? void 0 : product.current_stock) === 0) {
        console.log('   ✅ PASS');
        return true;
    }
    else {
        console.error(`   ❌ FAIL: Stock is ${product === null || product === void 0 ? void 0 : product.current_stock} (Expected 0). Successes: ${successes.length} (Expected 1).`);
        return false;
    }
}
async function runScenario2_NegativeData() {
    ...
    if (error || (data && !data.success)) {
        ...
        const { data: product } = await supabase
            ...
            .eq('id', TEST_PRODUCT_ID)
            .single();
        if ((product === null || product === void 0 ? void 0 : product.current_stock) !== 0) {
...
async function runScenario3_GhostMovement() {
    ...
    const { data: productFinal } = await supabase
        ...
        .eq('id', TEST_PRODUCT_ID)
        .single();
    const sumMovements = (movementsFinal === null || movementsFinal === void 0 ? void 0 : movementsFinal.reduce((acc, curr) => acc + curr.quantity_change, 0)) || 0;
    const currentStock = (productFinal === null || productFinal === void 0 ? void 0 : productFinal.current_stock) || 0;
